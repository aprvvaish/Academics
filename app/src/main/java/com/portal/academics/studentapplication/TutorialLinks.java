...
public class TutorialLinks extends AppCompatActivity {
    ...
    public class GetTutorials extends AsyncTask<Void,Void,Void>
    {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                ResultSet reset = stmt.executeQuery(" select link from tutorials where course= '" + course + "'");
        ...
        protected void onPostExecute(Void aVoid) {
            itemsAdapter =new ArrayAdapter<String>(TutorialLinks.this, android.R.layout.simple_list_item_1, list);
